...
class WS00TypeCheckingWorksheet {
   ...
   */
  String p06MajorKeyToSuccessInCOMP110(WS00ClueGiver clues) {
    return "<answer>";
  }
   ...
   */
  String p13AnotherMajorKeyToSuccessInCOMP110(WS00ClueGiver clues) {
    return "<answer>";
  }
  ...
  /**
   * We'll start challenge problems next week!
   */
